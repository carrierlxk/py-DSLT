...
class Config:
    def __init__(self):
        ...
        self.net_base_path = "/media/xiankai/Data/tracking/SiamFC-PyTorch/Train/model"#"/home/hfan/Desktop/PyTorch-SiamFC/Train/model/"
        # path to your sequences (sequence should be in OTB format)
        self.seq_base_path = "/home/xiankai/work/OTB"#"/home/hfan/Desktop/demo-sequences/"
        # which model to use
        self.net = "SiamFC_50_model-origion.pth"
